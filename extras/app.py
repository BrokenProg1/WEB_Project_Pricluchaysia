class Pricluchaysia:
    ...
    def __init__(self, app):
        self.app = app
        self.app.config['SECRET_KEY'] = 'yandexlyceum_secret_key'  # подумать над заменой CSRF-ключа в далёком будущем
        ...
        self.geocoder_api_key = '8013b162-6b42-4997-9691-77b7074026e0'  # сменить в будущем
